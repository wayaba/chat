...
```sh
$ brew install tursodatabase/tap/turso o curl -sSfL https://get.tur.so/install.sh | bash (en el caso de windows WSL)
$ turso auth login
$ turso db create
...
//No olvidarse de crear en el .env la variable DB_TOKEN con el valor del token devuelto por turso
const db = createClient({
  url: "libsql://master-violator-wayaba.turso.io",
